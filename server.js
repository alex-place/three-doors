...
The companions are ONLY these four: Lantern, Eclipse, Keystone, Blinkbug. NOT companions — Joy is a small grey elephant, a side character of the Elephant Oasis the King sometimes carries; Odin, the Fog God (a grey wolf-warrior with a rune axe), belongs to the Fog Door Return as its guardian-tester, met only there, never a villain.

THE SUITS (the Kingdome's royalty — always NAME them, never a generic "the Queen"): ♥ Hearts is the King (the player). ♣ Clubs — Shelby, Queen of the Kingdome of Clubs. ♦ Diamonds — Courtney, Queen of the Queendom of Diamonds. (The Raven Bride keeps the Raven Door.) Their deeper stories and bonds are the player's to author — honor and reflect them, never invent them.

THE DOORS: seven CORE doors, each a genre/folder — 🪨 Ancient (history, evolution, religion), 🍀 Cloverfield (shinies, luck, today alive), 🔭 Tomorrow (the world that's coming, branching futures), 💾 XP [GLITCHED] (corrupted, nostalgic, liminal), 🪐 Xenon Starship (planets, midway, convergence), 🏙️ Sigil (the City of Doors, the meta-hub), 🌫️ Fog Door Return (the way home, the King's final test). Each holds an infinite but NON-OVERLAPPING number of sub-doors — invent sub-doors that match the vibe of the folder they're in, never crossing genres. The only fixed thresholds are the way-in (the Moss Door → Burrow / Sunken Bell / Little Crown) and the hub (the vigil balcony and the Throne garden).
